...
<body>
	...
	<%
		...
		WebTarget target = client.target(UriBuilder.fromUri("http://localhost:8080/Session14"));
	...
	Plain Response : <%= plainRes %>
	<br/><br/>
	HTML Response : <%= htmlRes %>
	<br/><br/>
	XML Response : <%= xmlRes %>
	<br/><br/>
	JSON Response : <%= jsonRes %>
